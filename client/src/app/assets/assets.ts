...
export const dummyMessagesData: Message[] = [
    {
...
// ========== بيانات الاتصالات ==========
export const dummyConnectionsData: User[] = [
  dummyUserData,
  dummyUser2Data,
  dummyUser3Data
];

export const dummyFollowersData: User[] = [
  dummyUser2Data,
  dummyUser3Data
];

export const dummyFollowingData: User[] = [
  dummyUser2Data,
  dummyUser3Data
];

export const dummyPendingConnectionsData: User[] = [
  dummyUserData
];